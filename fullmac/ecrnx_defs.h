...
#define IE_SIZE                      (256)
#define ECRNX_REORD_TIMEOUT          (100)
#define ECRNX_REORD_WINSIZE          (64)
#define SN_LESS(a, b)           (((a-b)&0x800)!=0)
#define SN_EQUAL(a, b)          (a == b)

#define SKIP_SN_LIST_CNT             (ECRNX_REORD_WINSIZE)
...
struct reord_cntrl {
    ...
    u16 win_start;
    short skip_idx;
    short skip_sn[SKIP_SN_LIST_CNT];
...
//bit0:support 11bgn
//bit1:support 11bg
//bit2:support 11bgnax
//bit3:support 11ax only
...
#define ecrnx_printk_always_CFM_ERR(req) \
...
#define ECRNX_WLAN_STATUS_ASSOC_UNSPEC 0xFE00
